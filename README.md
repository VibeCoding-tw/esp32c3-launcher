...
*   **視覺化 Web 控制介面**：內建基於 Tailwind CSS 的自適應虛擬搖桿介面，支援多點觸控與實時狀態回傳。
*   **進階馬達物理模擬**：
    *   **斜坡起步 (Ramping)**：模擬真實物理加速過程，避免電流瞬間過大造成的硬體損耗。
...
> [!TIP]
> **轉向保護機制**：轉向馬達 (S Motor) 若連續輸出超過 800ms，系統會自動將輸出功率降至 60% (PWM 150)，平衡轉向力矩與發熱保護。
